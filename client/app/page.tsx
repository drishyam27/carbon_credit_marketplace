...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-[#050510] overflow-hidden">
      ...
      {/* Hero + Content */}
      <main className="relative z-10 flex flex-1 w-full max-w-5xl mx-auto flex-col items-center px-4 sm:px-6 pt-6 sm:pt-10 pb-10 sm:pb-16">
        {/* Hero — compact */}
        <div className="mb-6 sm:mb-10 text-center animate-fade-in-up">
          ...
          {/* Inline stats */}
          <div className="mt-4 sm:mt-6 flex items-center justify-center gap-4 sm:gap-6 md:gap-10 animate-fade-in-up-delayed">
            {[
        ...
        {/* Footer */}
        <div className="mt-6 sm:mt-10 flex flex-col items-center gap-3 sm:gap-4 animate-fade-in">
          {/* Carbon credit flow */}
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-[10px] text-white/15">
